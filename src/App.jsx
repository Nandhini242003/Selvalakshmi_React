    ...
    <div className="w-full">
      ...
      <section id="home" className="relative h-[600px] overflow-hidden">
        ...
        >
          ...
          <button className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-3 rounded-md font-semibold transition-colors flex items-center gap-2">
      ...
      <div className="max-w-[1140px] mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 text-center gap-10">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-sm md:text-base">selvalakshmiandco@gmail.com</p>
          </div>
